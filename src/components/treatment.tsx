...
const Treatment = () => {
  ...
  const priceItems = [
    { service: 'Nail care', price: '$25', dashWidth: '2xl:w-[296px] md:w-[226px] w-[190px]' },
    { service: 'Hair Styling', price: '$30', dashWidth: '2xl:w-[273px] md:w-[203px] w-[167px]' },
    { service: 'Make up', price: '$50', dashWidth: '2xl:w-[297px] md:w-[227px] w-[191px]' },
    { service: 'Cosmetology', price: '$20', dashWidth: '2xl:w-[260px] md:w-[190px] w-[154px]' },
    { service: 'SPA procedures', price: '$30', dashWidth: '2xl:w-[240px] md:w-[170px] w-[144px]' },
  ]
  ...
  return (
    <section className='xl:py-20 py-5 bg-white'>
      <div className='flex flex-col md:flex-row justify-between items-center xl:px-20 px-5 2xl:max-w-[1400px] xl:max-w-[1150px] max-w-[900px] mx-auto'>
        {/* Mobile-only divider */}
        <div className='md:hidden border border-dashed w-full border-[#909090] mb-10' />
        ...
        >
          <h2 className='text-[50px] leading-tight'>Treatments and prices</h2>
          ...
          <div className='flex flex-col gap-4 mt-4'>
            {priceItems.map((item, index) => (
              ...
              >
                ...
                <div className={`${item.dashWidth} border-dashed border border-[#909090]`} />
          ...
          <Link
            href="#"
            className='text-[#6B0606] mt-6 underline 2xl:text-[16px] text-[14px] font-medium'
          >
            View all
          </Link>
        </motion.div>
