...
const Hairstyling = () => {
  ...
  return (
    <section className="xl:py-20 py-5 bg-white">
      <div className="flex flex-col md:flex-row-reverse justify-between items-center xl:px-20 px-5 2xl:max-w-[1400px] xl:max-w-[1150px] max-w-[900px] mx-auto">
        ...
        >
          <h2 className="text-[50px] leading-tight">Hair styling</h2>
