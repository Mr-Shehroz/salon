  ...
  return (
    <section className='bg-white py-20 px-5'>
        ...
        <div className='flex justify-center items-center gap-5 mt-16 flex-wrap'>
            <Image src="/Card.svg" alt="Elegance Image" width={350} height={600} className='2xl:w-[350px] lg:w-[300px] md:w-[300px]'/>
            <Image src="/Card 1.svg" alt="Elegance Image" width={350} height={600} className='2xl:w-[350px] lg:w-[300px] md:w-[300px]'/>
            <Image src="/Card 2.svg" alt="Elegance Image" width={350} height={600} className='2xl:w-[350px] lg:w-[300px] md:w-[300px]'/>
            <Image src="/Card 3.svg" alt="Elegance Image" width={350} height={600} className='2xl:w-[350px] lg:w-[300px] md:w-[300px]'/>
        </div>
    </section>
  )
}
